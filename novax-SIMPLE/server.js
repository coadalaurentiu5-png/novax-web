...
if (cluster.isMaster) {
    ...
    async function sendDiscordStaffNotification(payload) {
        ...
        // Discord cere un User-Agent valid — fără el, Cloudflare blochează cu 1015/429
        const headers = {
        ...
        for (let attempt = 1; attempt <= maxAttempts; attempt++) {
            try {
                const resp = await fetch(DISCORD_WEBHOOK_URL, { method: 'POST', headers, body });

...
if (cluster.isMaster) {
    ...
    const CATALOG = {
        ...
        'fivem-account':     { id: 'fivem-account',     sku: 'FIVEM-ACC',    name: 'Cont FiveM Ready',     priceEUR: 0.50, badge: 'READY', features: ['Cont FiveM gata de utilizare', 'Verificat & funcțional', 'Livrare instant pe Discord'] },
        'fivem-program':     { id: 'fivem-program',     sku: 'FIVEM-PROG',   name: 'Program FiveM',        priceEUR: 25.00, badge: 'PREMIUM', features: ['Program complet FiveM', 'Actualizări constante', 'Suport & garanție'] },
    };
